package com.mhj.cart.service.controller;
...
import com.mhj.cart.service.entity.Cart;
import com.mhj.cart.service.entity.Product;
...
public class CartController {
	...
	public Cart getCart(@Valid @PathVariable long userId) {
		...
		// p1
		Product p1 = new Product(1L, "keyboard", 250D, 2);
		p1.setTotlalPrice(p1.getBasePrice() * p1.getQuantity());
		products.add(p1);

		// p2
		Product p2 = new Product(2L, "mouse", 150D, 2);
